...
1.  **Phân Tích & Tổng Hợp Bài Giảng:**
    ...
    *   **Định Dạng Cấu Trúc:**
        ...
        *   **QUY TẮC NỘI DUNG KHÔNG THỪA (CỰC KỲ QUAN TRỌNG):** Khi tạo các khối \`tip\`, \`warning\`, và \`example\`, trường \`content\` **CHỈ** được chứa nội dung thực tế. **TUYỆT ĐỐI KHÔNG** bao gồm các tiền tố lặp lại như "Mẹo:", "Cảnh báo:", hoặc các biểu tượng (💡, ⚠️). Giao diện sẽ tự xử lý việc này.
